...
IF ~%SoD_VAR%Global("ACBREINPARTY","GLOBAL",2)~ THEN BEGIN KICKOUT.SOD
SAY @11
++ @2 + KICKOUT.SOD1
...
IF ~%SoD_VAR%Global("ACBREINPARTY","GLOBAL",3)~ THEN BEGIN REJOIN.SOD
SAY @19
++ @20 + REJOIN.SOD1
++ @21 EXIT
END
...
== ACBreP IF ~Global("bd_player_exiled","global",1)
!Dead("ACBre")
InMyArea("ACBre")
