...
CHAIN
IF ~Global("ACLASTPLOT","GLOBAL",0)%BG1_BEFORE_TRANSITION%GlobalLT("ACSILVERAPPEARS","GLOBAL",7)NumTimesTalkedTo(0)~ THEN ACSILVER FIRSTMEET.1
@36 
==ACBREJ @37   
==ACSILVER @38   
END
...
CHAIN
IF ~Global("ACLASTPLOT","GLOBAL",0)%BG1_BEFORE_TRANSITION%GlobalGT("ACSILVERAPPEARS","GLOBAL",6)NumTimesTalkedTo(0)~ THEN ACSILVER SILVERSTART2
@70  = @71
==ACBREJ @72
==ACSILVER @73 = @74   
==ACBREJ @75
...
CHAIN
IF ~%BG1_BEFORE_TRANSITION%Global("ACLASTPLOT","GLOBAL",0)Global("AC25PLOT","GLOBAL",0)NumTimesTalkedTo(1)~ THEN ACSILVER REMEET.2
@80
==ACBREJ @81 = @82
==ACSILVER @83
==ACBREJ @84
