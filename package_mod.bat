...
set "mod_name=Ascalon's Breagar"
set "mod_version=v12-1-0"
set mod_folder=ACBre
...
REM /* set ico_folder=%mod_folder%\style */
set audio_folder=%mod_folder%\tools
set tispack_folder=%mod_folder%\tisunpack
set tile2ee_folder=%mod_folder%\tools\tile2ee
set iconv_folder=%mod_folder%\tools\iconv
REM /* set mod_readme=http://www.gibberlings3.net/readmes/readme-%mod_folder%.html */
